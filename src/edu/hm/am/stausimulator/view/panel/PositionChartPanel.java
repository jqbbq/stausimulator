...
public class PositionChartPanel extends Panel {
	...
	public PositionChartPanel(Road road, int laneIndex) {
	...
	private class ImagePanel extends JPanel {
		...
		public void paint(Graphics g) {
			...
			BufferedImage image = PositionChart.draw(road.getLane(laneIndex).getData(), (int) scrollPane.getVisibleRect().getHeight(), false, false);
